...
- **请勿在 ISSUE 区提交 NSFW 的创意**

## 💡 注意事项
- `01_World/初始创意.md` 是可选的，不提供这个文件直接开聊也可以
...
- Token 消耗量还是挺大的，用贵模型的话悠着点
  ...
  - `GLM 4.7` 有个编程套餐，只用来写文的话基本用不完（P.S 后台可以关审查） [→ [GLM Coding Plan] ←](https://www.bigmodel.cn/glm-coding?ic=YR3PVFFFFE)
